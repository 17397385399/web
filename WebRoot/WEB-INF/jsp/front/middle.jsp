          ...
          <div class="am-g">
            <div class="am-u-md-3">
              <div class="features_item">
								<img src="${pageContext.request.contextPath}/res/images/index/f01.jpg" alt="">
            ...
            <div class="am-u-md-3">
              <div class="features_item">
								<img src="${pageContext.request.contextPath}/res/images/index/f02.jpg" alt="">
            ...
            <div class="am-u-md-3">
              <div class="features_item">
								<img src="${pageContext.request.contextPath}/res/images/index/f03.jpg" alt="">
            ...
            <div class="am-u-md-3">
              <div class="features_item">
								<img src="${pageContext.request.contextPath}/res/images/index/f04.jpg" alt="">
  ...
  <div class="promo_detailed">
        ...
        <div class="am-g">
          ...
          <div class="am-u-md-6">
            <div class="promo_detailed--cta">
              ...
              <div class="promo_detailed-img am-show-sm-only" style="background-image: url('${pageContext.request.contextPath}/res/images/index/promo_detailed_bg.jpg');"></div>
            </div>
          </div>
    ...
    <div class="promo_detailed-img am-hide-sm-only" style="background-image: url('${pageContext.request.contextPath}/res/images/index/promo_detailed_bg.jpg');"></div>
  </div>
  <!--promo_detailed end-->
      ...
      <div class="container">
        <div class="am-g">
          <div class="am-u-md-2 am-u-sm-4 customer-box">
            <a href="#">
              <img class="normal-logo" src="${pageContext.request.contextPath}/res/images/index/customer_logo_Microsoft.png" alt="" />
              <img class="am-active"  alt=""src="${pageContext.request.contextPath}/res/images/index/customer_logo_Microsoft_active.png" alt="" />
            </a>
          </div>
          <div class="am-u-md-2 am-u-sm-4 customer-box">
            <a href="#">
              <img class="normal-logo" src="${pageContext.request.contextPath}/res/images/index/customer_logo_qhdx.png" alt="" />
              <img class="am-active" src="${pageContext.request.contextPath}/res/images/index/customer_logo_qhdx_active.png" alt="" />
            </a>
          </div>
          <div class="am-u-md-2 am-u-sm-4 customer-box">
            <a href="#">
              <img class="normal-logo" src="${pageContext.request.contextPath}/res/images/index/customer_logo_gmw.png" alt="" />
              <img class="am-active" src="${pageContext.request.contextPath}/res/images/index/customer_logo_gmw_active.png" alt="" />
            </a>
          </div>
          <div class="am-u-md-2 am-u-sm-4 customer-box">
            <a href="#">
              <img class="normal-logo" src="${pageContext.request.contextPath}/res/images/index/customer_logo_gov.png" alt="" />
              <img class="am-active" src="${pageContext.request.contextPath}/res/images/index/customer_logo_gov_active.png" alt="" />
            </a>
          </div>
          <div class="am-u-md-2 am-u-sm-4 customer-box">
            <a href="#">
              <img class="normal-logo" src="${pageContext.request.contextPath}/res/images/index/customer_logo_jl.png" alt="" />
              <img class="am-active" src="${pageContext.request.contextPath}/res/images/index/customer_logo_jl_active.png" alt="" />
            </a>
          </div>
          <div class="am-u-md-2 am-u-sm-4 customer-box">
            <a href="#">
              <img class="normal-logo" src="${pageContext.request.contextPath}/res/images/index/customer_logo_hx.png" alt="" />
              <img class="am-active" src="${pageContext.request.contextPath}/res/images/index/customer_logo_hx_active.png" alt="" />
            </a>
          </div>
        </div>
      </div>
  ...
  <div class="section" style="margin-top:0px;background-image: url('${pageContext.request.contextPath}/res/images/pattern-light.png');">
    <div class="container">
      <!--index-container start-->
      <div class="index-container">
        <div class="am-g">
